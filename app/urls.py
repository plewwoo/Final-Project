...
urlpatterns = [
	...
	path('course-detail/<str:username>', courseDetail, name='course-detail'),
	path('course-detail/<str:username>/<int:id>', courseDetail2, name='course-detail-2'),
	path('teacher-register', teacherRegister, name='teacher-register'),
	path('teacher-info/<str:username>/edit', teacherEditInfo, name='teacher-edit-info'),
	...
	path('quiz/<int:id>/<pk>/save/', save_quiz_view, name='save-data-view'),
